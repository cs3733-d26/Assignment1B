...
*DUE: Tuesday, March 24 by 11:59pm.  
Late penalty of 6 points (out of 60 total points) if submitted by Wednesday, March 25 by noon.*
...
* In the top directory of the project, create `index.html` that is a web page about your favorite hobby. Refer to the HTML tutorial at [W3 Schools](https://www.w3schools.com/html/) or elsewhere, if needed. You will include the following HTML elements below **in order**: 
  ...
  * A rectangular image related to your hobby (sort of like a banner for the web page). You may use an AI image generator like ChatGPT or [https://deepai.org/styles](https://deepai.org/styles) to create the image if you want. Resize the image so the width is no larger than 1024 pixels. The image should be located in the `public` folder.
 ...
 * Run the following commands to install the node.js packages for the server.
